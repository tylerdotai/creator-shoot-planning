...
## On Location: Pre-Shoot (First 15 Minutes)

1. **Walk the location once without the camera.**
   - Find your first setup.
   - Identify where you'll transition to after.
   - Note where the light is.

2. **Set up the audio first.**
   - Attach wireless mic to subject.
   - Check receiver LED.
...
4. **Do a wide shot first.**
   ...
   - Confirm lighting and audio are working.
   - This is your confidence builder.

---

## On Location: Shooting Flow
...
- Take 10 seconds to play back the last clip.
- If something is wrong, you catch it before you've shot 30 minutes of bad audio.

**Rule: Keep moving.**
- If you finish a setup and don't know what's next — walk.
- Find new light. Find a new wall. Find a new angle.
...
- **Forgetting to check the mic LED mid-shoot.** Connection drops. Batteries die.

---

## Post-Shoot: Immediately After

1. **Offload footage before you do anything else.**
   - SD card to computer, or tether to phone.
   - Don't wait — the longer you wait, the more likely you lose files.

2. **Watch 60 seconds of selects in camera.**
   - Flag the clips that feel right.
   - Don't start editing — just identify the best 30 seconds.

3. **Back up raw footage.**
   - Copy to two drives minimum.
   - Cloud backup if it's critical content.

4. **Pull selects within 24 hours.**
   - Context fades fast.
   - What felt obvious in the moment is confusing a week later.

---

## Post-Shoot Debrief

Answer these questions while the shoot is fresh:

1. What worked that I'd do again?
2. What didn't work that I'd change?
3. What shot did I not get that I wish I had?
4. What angle surprised me?
